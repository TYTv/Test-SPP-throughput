...
uint8_t BT_LOCAL_NAME[] = { 'Z','e','n','i','t','r','o','n','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    {
        .max_links                      = SPP_MAX_CONNECTIONS,                                                           /**< Maximum number of simultaneous connected remote devices*/
        .max_ports                      = SPP_MAX_CONNECTIONS                                                            /**< Maximum number of simultaneous RFCOMM ports */
    },
